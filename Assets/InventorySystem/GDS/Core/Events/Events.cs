...
namespace GDS.Core.Events {
    ...
    public record SavePlayerData() : CustomEvent;
    public record LoadPlayerData() : CustomEvent;

    public record RotateItemEvent() : CustomEvent;
    public record IllegalActionEvent() : CustomEvent;


    public abstract record ResultEvent : CustomEvent { public static Fail Fail = new(); public static Success Success = new(); };
    public record Success : ResultEvent;
    public record Fail : ResultEvent;
